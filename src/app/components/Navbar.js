  ...
  return (
    ...
    <div className="navbar">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
            ...
            <li><Link href="/fineas">Fineas</Link></li>
      ...
      <div className="navbar-center">
        <a className="btn btn-ghost text-xl"><Link href="/">Fineas</Link></a>
      </div>
      <div className="navbar-end">
        ...
        <Link href="/login">
          <button className="btn m-2 px-2 py-1">Login</button>
        </Link>
        <Link href="/signup">
          <button className="btn m-2">Sign Up</button>
        </Link>
        <button onClick={handleSignOut} className="btn m-2">Sign Out</button>
      </div>
    </div>
  );
}
